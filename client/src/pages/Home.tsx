...
].map(([file, _label, size], index) => ({ src: mediaUrl(file), title: "СТЕНА", meta: `СТЕНЫ / ${String(index + 1).padStart(2, "0")} / 34`, tag: "Пользовательский архив EffectGraff", size: size as ImageRecord["size"] }));
